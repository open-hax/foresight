  ...
  [{:source/id :agents
   ...
   {:source/id :services
    ...
    {:source/id :shx
     ...
     :source/actionable? true
     :source/invariants []}
    {:source/id :kanban-orchestrator
     :source/name "kanban-orchestrator"
     :source/path "kanban-orchestrator"
     :source/type :git-submodule
     :source/repository "open-hax/kanban-orchestrator"
     :source/url "git@github.com:open-hax/kanban-orchestrator.git"
     :source/ownership :independent-repository
     :source/role :agent-contract-data
     :source/actionable? true
     :source/invariants []}
    {:source/id :clio
     :source/name "clio"
     :source/path "clio"
     :source/type :git-submodule
     :source/repository "open-hax/clio"
     :source/url "git@github.com:open-hax/clio.git"
     :source/ownership :independent-repository
     :source/role :event-sourcing-kernel
     :source/actionable? true
     :source/invariants []}
    {:source/id :chat-ui
     :source/name "chat-ui"
     :source/path "chat-ui"
     :source/type :git-submodule
     :source/repository "open-hax/chat-ui"
     :source/url "git@github.com:open-hax/chat-ui.git"
     :source/ownership :independent-repository
     :source/role :chat-ui-components
     :source/actionable? true
     :source/invariants []}
    {:source/id :rheos
     :source/name "rheos"
     :source/path "rheos"
     :source/type :git-submodule
     :source/repository "open-hax/rheos"
     :source/url "git@github.com:open-hax/rheos.git"
     :source/ownership :independent-repository
     :source/role :kanban-board-runtime
     :source/actionable? true
     :source/invariants []}
    {:source/id :session-mycology
     :source/name "session-mycology"
     :source/path "session-mycology"
     :source/type :git-submodule
     :source/repository "open-hax/session-mycology"
     :source/url "git@github.com:open-hax/session-mycology.git"
     :source/ownership :independent-repository
     :source/role :session-reflection-events
     :source/actionable? true
     :source/invariants []}
    {:source/id :sol
     :source/name "sol"
     :source/path "sol"
     :source/type :git-submodule
     :source/repository "open-hax/sol"
     :source/url "git@github.com:open-hax/sol.git"
     :source/ownership :independent-repository
     :source/role :agent-runtime-backend
     :source/actionable? true
     :source/invariants []}
    {:source/id :osmos
     :source/name "osmos"
     :source/path "osmos"
     :source/type :git-submodule
     :source/repository "open-hax/osmos"
     :source/url "git@github.com:open-hax/osmos.git"
     :source/ownership :independent-repository
